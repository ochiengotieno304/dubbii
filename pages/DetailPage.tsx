...
const SectionTitle: React.FC<{children: React.ReactNode, className?: string, icon?: React.ReactNode}> = ({children, className = "", icon}) => (
    <div className={`flex items-center mb-6 ${className}`}>
      ...
      <h2 className={`text-2xl md:text-3xl font-bold text-neutral dark:text-gray-100 border-l-4 border-secondary pl-4 py-1`}>{children}</h2>
    </div>
);
...
const SeasonsAndEpisodes: React.FC<{
  ...
  return (
    <div>
      <div className="flex space-x-2 mb-6 pb-2 border-b border-gray-200 dark:border-gray-700 overflow-x-auto" role="tablist" aria-label="TV Seasons">
      ...
      {currentSeason ? (
        ...
        >
          <div className="md:w-1/3 lg:w-1/4 mb-6 md:mb-0 max-h-[500px] md:max-h-[calc(var(--player-aspect-ratio,0.5625)*100vh+150px)] lg:max-h-[calc(var(--player-aspect-ratio,0.5625)*80vh+150px)] overflow-y-auto pr-2 space-y-1.5 custom-scrollbar">
            {currentSeason.episodes && currentSeason.episodes.length > 0 ? (
                ...
                <button
                  ...
                  className={`w-full text-left p-3 rounded-lg transition-colors duration-150 ease-in-out block focus:outline-none focus-visible:ring-1 focus-visible:ring-accent
          ...
          <div className="md:w-2/3 lg:w-3/4">
            ...
            {selectedEpisode ? (
              <div className="bg-primary dark:bg-gray-800 p-4 md:p-6 rounded-b-xl shadow-xl mt-0"> {/* Removed top rounding, adjusted margin */}
                <h4 className="text-xl font-semibold text-neutral dark:text-gray-100 mt-0 mb-1"> {/* Adjusted margin */}
      ...
      try {
        ...
        if (details) {
          ...
          if (details.type === 'movie') {
            setPlayerEmbedUrl(`https://vidsrc.xyz/embed/${details.id}`);
      ...
      <div className="relative z-0 pt-8 md:pt-12">
        <div className="md:flex md:space-x-8 lg:space-x-12 mb-10 md:mb-12">
          ...
          <div className="md:w-2/3 lg:w-3/4">
            ...
            <div className="mb-3 md:mb-4"> {/* Adjusted margin */}
            ...
            <button
              ...
              className={`inline-flex items-center justify-center px-4 py-2.5 rounded-lg font-semibold text-sm transition-all duration-200 ease-in-out shadow-md hover:shadow-lg active:scale-95 transform mb-5 md:mb-6
                ${isInWatchLater
            ...
            <div className="mb-6">
                <h3 className="text-xl md:text-2xl font-semibold text-gray-900 dark:text-white mt-0 mb-2">Overview</h3> {/* Adjusted margin */}
